...
|---|---|
| `hooks/` | The Code Work Gate and its anomaly inbox, the continuity system, the comment-density guard, chip handoff and session hygiene — plus their regression suites (1249 gate assertions, 70 continuity checks, 48 guard cases, chip and hygiene suites) |
