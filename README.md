...
|---|---|
| `hooks/` | The Code Work Gate, the continuity system, the comment-density guard, chip handoff and session hygiene — plus their regression suites (926 gate assertions, 70 continuity checks, 48 guard cases, chip and hygiene suites) |
