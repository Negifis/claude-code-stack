---
name: adversarial-reviewer-xhigh
description: 'XHIGH run of adversarial-reviewer: the same read-only reviewer at max effort. Hand over the candidate, acceptance criteria, round number, finding ledger and remediation delta.'
