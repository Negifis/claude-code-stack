...
description: 'Read-only quality lens of the HIGH simplify pass: readability, naming, control flow, type and error clarity, tests, comments and dead code, behavior-preserving, with file:line evidence.'
